...
export class GetChartQueryDto extends createZodDto(getChartQuerySchema) {}
...
const getChartResSchema = z.object({
  quotes: quoteSchema.array(),
});

export class GetChartResDto extends createZodDto(getChartResSchema) {}
